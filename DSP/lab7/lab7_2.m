...
legend('M1=7', 'M2=31', 'M3=61', 'M4=109');
title('LPF using bartlett window');
xlabel('Normalised frequency');
ylabel('Magnitude in dB');
 
%Blackman Window
w17 = blackman(M1);
bw17 = fir1(M1-1,wn,w17);
[H17,W17] = freqz(bw17,1,[-pi:0.001:pi]);
 
w18 = blackman(M2);
bw18 = fir1(M2 - 1,wn,w18);
[H18,W18] = freqz(bw18,1,[-pi:0.001:pi]);
 
w19 = blackman(M3);
bw19 = fir1(M3 - 1,wn,w19);
[H19,W19] = freqz(bw19,1,[-pi:0.001:pi]);
 
w20 = blackman(M4);
bw20 = fir1(M4 - 1,wn,w20);
