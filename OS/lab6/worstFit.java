...
public class worstFit {
    ...
    static void allocateProcessWorstFit(String PID, int processSize) {
        int i = 0;
        int maxIndex = -1;
        int maxSize = Integer.MIN_VALUE;
        for (Block current : memory) {
            if (current.free && current.size >= processSize && current.size > maxSize) {
        ...
        if(maxIndex == -1)
            ...
            allocateBlock(PID, processSize, maxIndex);
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            case 1:
                ...
                allocateProcessWorstFit(PID, processSize);
                printMemory();
                break;
            case 2:
                System.out.println("Enter process ID");
