...
public class bestFit {
    ...
    static void allocateProcessBestFit(String PID, int processSize) {
        int i = 0;
        int minIndex = -1;
        int minSize = Integer.MAX_VALUE;
        for (Block current : memory) {
            if (current.free && current.size >= processSize && current.size < minSize) {
        ...
        if(minIndex == -1)
            ...
            allocateBlock(PID, processSize, minIndex);
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            case 1:
                ...
                allocateProcessBestFit(PID, processSize);
                printMemory();
                break;
            case 2:
                System.out.println("Enter process ID");
